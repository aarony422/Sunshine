...
import static com.example.android.sunshine.app.Utility.getFriendlyDayString;
...
public class ForecastAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int date = cursor.getInt(ForecastFragment.COL_WEATHER_DATE);
        String formattedDate = getFriendlyDayString(context, date);
